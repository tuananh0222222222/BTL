					...
					<div class="table-responsive">
		                     ...
		                     <form  action="./StudentAdd" method="post" style="width: 700px;">	
		                        ...
		                        <div class="form-group">
		                            ...
		                            <input type="text" class="form-control" name="student-name" required="required" >
		                        </div>
		                          
		                           <div class="form-group">
		                            <label for="">Năm sinh</label>
		                            <input type="date" class="form-control" name="student-birth" required="required">
		                        </div>
		                            ...
		                            <label for="">Giới tính</label>
						             <select name="student-gender" required="required" class="form-control">
						             	<option>Nam</option>
						             		<option>Nữ</option>
						             </select>
		                        ...
		                        <div class="form-group">
		                            ...
		                            <input type="text" class="form-control" name="student-phone" required="required">
		                        </div>
		                        
		                        <div class="form-group">
		                            <label for="">Địa chỉ</label>
		                            <input type="text" class="form-control" name="student-address" required="required">
		                        </div>
